...
def main():
    ...
    hermann.add_argument("--cells", type=int, default=5, metavar="", help="Number of cells on each side of the grid")
    hermann.add_argument("--size", type=int, default=600, metavar="", help="Size of grid illusion (pixels)")
    ...
    scintillating.add_argument("--cells", type=int, default=12, metavar="", help="Number of cells on each side of the grid")
    scintillating.add_argument("--size", type=int, default=600, metavar="", help="Size of grid illusion (pixels)")
    ...
    bergen.add_argument("--cells", type=int, default=10, metavar="", help="Number of cells on each side of the grid")
    bergen.add_argument("--size", type=int, default=600, metavar="", help="Size of grid illusion (pixels)")
    ...
    ninio.add_argument("--square_colour", type=str, default="white", metavar="", help="Square fill colour")
    ...
    mcanany_levine.add_argument("--cells", type=int, default=10, metavar="", help="Number of cells on each side of the grid")
    mcanany_levine.add_argument("--size", type=int, default=600, metavar="", help="Size of grid illusion (pixels)")
