...
def main():
    ...
    ninio.add_argument("--grid_width", type=int, default=6, metavar="", help="Width of grid lines")
    ninio.add_argument("--blur_strength", type=int, default=0, metavar="", help="Strength of Gaussian blur")
    ninio.add_argument("--dot_radius", type=int, default=4.5, metavar="", help="Radius of dots")
