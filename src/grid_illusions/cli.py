...
def main():
    ...
    scintillating.add_argument("--size", type=int, default=600, metavar="", help="Size of square (pixels)")
    ...
    bergen.add_argument("--size", type=int, default=600, metavar="", help="Size of square (pixels)")
    ...
    ninio.add_argument("--cells", type=int, default=(16, 16), metavar="", help="Number of grid cells")
    ninio.add_argument("--size", type=int, default=(800, 575), metavar="", help="Size of square (pixels)")
    ...
    ninio.add_argument("--grid_width", type=int, default=7, metavar="", help="Width of grid lines")
    ninio.add_argument("--blur_strength", type=int, default=0, metavar="", help="Strength of Gaussian blur")
    ninio.add_argument("--dot_radius", type=int, default=5.5, metavar="", help="Radius of dots")
    ...
    mcanany_levine.add_argument("--size", type=int, default=600, metavar="", help="Size of square (pixels)")
