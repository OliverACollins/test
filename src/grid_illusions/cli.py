...
def main():
    ...
    hermann.add_argument("--wiggle_strength", type=int, default=0, metavar="", help="Amplitude of distortion applied to grid lines")
    ...
    scintillating.add_argument("--dot_radius", type=int, default=5, metavar="", help="Radius of dots")
