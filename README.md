...
<figure>
 <img src = "src/media/pygrid_banner_2.png" alt = "PyGrid banner"/>
</figure>
...
The Bergen grid illusion (so-called due to... ), is more-or-less a combination of the Hermann and scintillating grid illusions. 
